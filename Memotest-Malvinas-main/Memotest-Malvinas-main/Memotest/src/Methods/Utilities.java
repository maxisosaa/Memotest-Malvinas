...
public class Utilities {
    ...
    public void imgStart() {
        Frame.Principal.btn01.setIcon(new ImageIcon());
        paintImage(Frame.Principal.btn01, 9);
        paintImage(Frame.Principal.btn02, 9);
        paintImage(Frame.Principal.btn03, 9);
        paintImage(Frame.Principal.btn04, 9);
        paintImage(Frame.Principal.btn05, 9);
        paintImage(Frame.Principal.btn06, 9);
        paintImage(Frame.Principal.btn07, 9);
        paintImage(Frame.Principal.btn08, 9);
    }
